...
namespace KI.RIS.DAL
{
    ...
    public sealed class MySqlHelper
    {
        ...
        /// <remarks>
        /// e.g.:  
        ///  OracleDataReader dr = ExecuteReader(connString, CommandType.StoredProcedure, "GetOrders", new MySqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">A valid connection string for a MySqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or PL/SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  OracleDataReader dr = ExecuteReader(conn, CommandType.StoredProcedure, "GetOrders", new MySqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connection">A valid MySqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or PL/SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///   OracleDataReader dr = ExecuteReader(trans, CommandType.StoredProcedure, "GetOrders", new MySqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="transaction">A valid MySqlTransaction</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or PL/SQL command</param>
            ...
            using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(command))
            {
                ...
                if (tableNames != null && tableNames.Length > 0)
                {
                    ...
                    for (int index = 0; index < tableNames.Length; index++)
                    {
                        ...
                        // Modified By Arun Rajan T 12-Aug-2009
                        dataAdapter.TableMappings.Add(tableName + (index != 0 ? index.ToString() : string.Empty), tableNames[index]);
        ...
        /// </remarks>
        /// <param name="insertCommand">A valid transacPL/SQL statement or stored procedure to insert new records into the data source</param>
        /// <param name="deleteCommand">A valid transacPL/SQL statement or stored procedure to delete records from the data source</param>
        /// <param name="updateCommand">A valid transacPL/SQL statement or stored procedure used to update records in the data source</param>
        ...
        public static void UpdateDataset(MySqlCommand insertCommand, MySqlCommand deleteCommand, MySqlCommand updateCommand, DataSet dataSet, string tableName)
        {
            ...
            using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter())
            {
                ...
                //dataSet.AcceptChanges(); // Commented by Medilogics Team

                //If you have two tables Master and Details, then executing the above code line will not work, you need the following code line to be executed.
                dataSet.Tables[tableName].AcceptChanges(); // Added by Medilogics Team
            }
        }
        #endregion
